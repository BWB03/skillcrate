...
**Open-source marketplace for Amazon seller agent skills.**

Find, install, and share modular tools and automations for Amazon selling workflows.
...
Built a tool that automates part of your Amazon workflow? [Submit it here](https://github.com/BWB03/skillcrate/issues/new?template=submit-a-skill.yml).
